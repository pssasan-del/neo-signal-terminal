...
void main() => runApp(const KingBroTradeApp());

class KingBroTradeApp extends StatefulWidget {
  const KingBroTradeApp({super.key});
  @override State<KingBroTradeApp> createState() => _KingBroTradeAppState();
}

class _KingBroTradeAppState extends State<KingBroTradeApp> {
  ...
  @override Widget build(BuildContext context){
    return MaterialApp(debugShowCheckedModeBanner:false,title:'King Bro Trade',theme:KingBroTheme.theme,home:ready?TerminalShell(baseUrl:baseUrl,onBaseUrl:_save):const Scaffold(body:Center(child:CircularProgressIndicator())));
  }
}
...
class PageFrame extends StatelessWidget{
 ...
 Widget build(BuildContext context) => DecoratedBox(
   decoration: const BoxDecoration(gradient: KbColors.backgroundGradient),
   child: RefreshIndicator(
     color: KbColors.emerald,
       ...
       slivers: [
         SliverAppBar(
           ...
           title: Column(
             ...
             children: [
               Text(title, style: const TextStyle(fontWeight: FontWeight.w900, letterSpacing: .2)),
               const Text('Powered by Raaja Bro', style: TextStyle(fontSize: 10, color: KbColors.cyan, fontWeight: FontWeight.w700, letterSpacing: .45)),
             ],
           ),
           actions: actions,
         ),
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              style: TextStyle(color: KbColors.textSecondary),
            ),
          ],
        ),
      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(color: KbColors.textSecondary),
                      ),
                    ],
                  ),
                ),
